...
def momemtum_collision_test():
    ...
    data = run(positions, velocity, mass, 1, True, 0.1, 10, 10, interactions.get_forces_zeroes)
...
if __name__ == '__main__':
    print(f'COLISSION TEST: {momemtum_collision_test()}')
